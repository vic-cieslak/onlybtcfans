...
export default {
  ...
  methods: {
    ...
    // [new] I switched QUploaderBase for createUploaderComponent,
    // as the former is depreceated in quasar 2.0
    //  not sure if this is still needed, don't care to verify at this point
    abort () {},
